...
public struct ZHPrivateKey {
    ...
    public var publicKey: ZHPublicKey {
        return ZHPublicKey(privateKey: self, chainCode: chainCode, network: network, depth: depth, fingerprint: fingerprint, index: index)
    }
    ...
    public func derived(at index: UInt32, hardens: Bool = false) -> ZHPrivateKey {
