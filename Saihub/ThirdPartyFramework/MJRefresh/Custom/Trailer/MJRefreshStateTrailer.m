...
- (void)prepare {
    ...
    // 初始化文字
    [self setTitle:[NSBundle mj_localizedStringForKey:GCLocalizedString(@"MJRefreshTrailerIdleText")] forState:MJRefreshStateIdle];
    [self setTitle:[NSBundle mj_localizedStringForKey:GCLocalizedString(@"MJRefreshTrailerPullingText")] forState:MJRefreshStatePulling];
    [self setTitle:[NSBundle mj_localizedStringForKey:GCLocalizedString(@"MJRefreshTrailerPullingText")] forState:MJRefreshStateRefreshing];
}
