...
- (NSString *)localizedStringForKey:(NSString *)key value:(NSString *)value table:(NSString *)tableName {
    ...
    [[NSUserDefaults standardUserDefaults]setObject:currentLanguage forKey:GCLanguageKey];
    // 每次需要从语言包查询语言键值对的时候，都按照当前语言取出当前语言包
    NSBundle *currentLanguageBundle = currentLanguage ? (IsEmpty([[NSBundle mainBundle] pathForResource:currentLanguage ofType:@"lproj"])?nil:[NSBundle bundleWithPath:[[NSBundle mainBundle] pathForResource:currentLanguage ofType:@"lproj"]]) : nil;
